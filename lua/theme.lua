...
local lsp_v9 = function(bg)
  ...
  vim.api.nvim_set_hl(0, "@lsp.type.unresolvedReference", { undercurl = true, sp = ct.yellow })
  vim.api.nvim_set_hl(0, "@lsp.type.variable", { link = '@variable' })
  ...
  vim.api.nvim_set_hl(0, '@markup.list', { fg = ct.blue }) -- For special punctutation that does not fall in the catagories before)
  ...
  vim.api.nvim_set_hl(0, '@markup.emphasis', { italic = (vim.g.aurora_italic == 1) })
...
return {
  colorscheme = function()
    ...
    local function load_basic()
      ...
      vim.api.nvim_set_hl(0, 'PMenuSel', { fg = ct.white, bg = ct.neardark5, ctermfg = 189, ctermbg = 238, bold = (vim.g.aurora_bold == 1), italic = (vim.g.aurora_italic == 1)})
      ...
      vim.api.nvim_set_hl(0, 'WarningMsg', { sp = ct.yellow7, undercurl = true })
      ...
      vim.api.nvim_set_hl(0, 'Keyword', { fg = ct.purple0, ctermfg = 183, bold = (vim.g.aurora_bold == 1), italic = (vim.g.aurora_italic == 1) })
    ...
    async = uv.new_async(vim.schedule_wrap(function()
      ...
      vim.api.nvim_set_hl(0, 'LspSignatureActiveParameter', { fg = 'NONE', bg = ct.darkpurple2, ctermfg = 'NONE', ctermbg = 53, sp = ct.yellow2, bold = (vim.g.aurora_bold == 1), underline = true, italic = (vim.g.aurora_italic == 1)})
      ...
      vim.api.nvim_set_hl(0, 'goBuiltins', { fg = ct.blued, bg = bg, ctermfg = 45, ctermbg = 'NONE', bold = (vim.g.aurora_bold == 1), italic = (vim.g.aurora_italic == 1)})
